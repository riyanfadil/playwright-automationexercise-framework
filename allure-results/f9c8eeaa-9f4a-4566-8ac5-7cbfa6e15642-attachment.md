...
Call log:
  - waiting for locator('button.close-modal') to be visible
    23 × locator resolved to hidden <button data-dismiss="modal" class="btn btn-success close-modal btn-block">Continue Shopping</button>
    ...
    - generic [ref=e5]:
      ...
      - list [ref=e12]:
        ...
        - listitem [ref=e40]:
          - generic [ref=e41]:
            - generic [ref=e42]: 
            - text: Logged in as Thaddeus Hilpert
  - generic [ref=e44]:
